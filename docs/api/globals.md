...
- [RecDiagnostics](interfaces/RecDiagnostics.md)
- [RecRankRequest](interfaces/RecRankRequest.md)
- [RecResponse](interfaces/RecResponse.md)
- [RecTimingMs](interfaces/RecTimingMs.md)
- [RecTraceInfo](interfaces/RecTraceInfo.md)
- [ScoredArticle](interfaces/ScoredArticle.md)

## Type Aliases

- [Action](type-aliases/Action.md)
- [RecCacheStatus](type-aliases/RecCacheStatus.md)
...
- [isValidEvent](functions/isValidEvent.md)
