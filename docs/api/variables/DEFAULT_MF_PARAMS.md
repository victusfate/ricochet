...
[@victusfate/ricochet](../globals.md) / DEFAULT\_MF\_PARAMS

# Variable: DEFAULT\_MF\_PARAMS

> `const` **DEFAULT\_MF\_PARAMS**: [`MfParams`](../interfaces/MfParams.md)

Defined in: [scoring.ts:39](https://github.com/victusfate/ricochet/blob/main/src/scoring.ts#L39)
